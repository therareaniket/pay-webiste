                            ...
                            <TabsContent value="integrity">
                                <div className="trust-tab-content">
                                    <div className="trust-info">
                                        ...
                                        <p>Secure tamper-proof records of every clinical trials transaction ensure full transparency and regulatory compliance. DhatuPay&apos;s immutable audit trails create verifiable histories that meet healthcare standards effortlessly.</p>
                                    </div>
