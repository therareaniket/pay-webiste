        ...
        <section className='termsmain inner-page section'>
            <div className="container-sm">
                ...
                <div className="terms-condition-main">
                    <div className='--bg-white terms-section-1 section-sm'>
                        <div className="container-sm">
                            <h2 className='h3'>1. Acceptance & Eligibility</h2>

                            <p className='text-20 text-rg'>By using DhatuPay, you affirm you are of legal age and authorized by your organization. If you do not agree to these Terms, do not use the service.</p>
                        </div>
                    </div>
                        ...
                        <div className="container-sm">
                            ...
                            <ul>
                                <li className='text-20 text-rg'><strong>License</strong> Subject to these Terms and any Order, DFOLDS grants you a
                                    <strong>non‑exclusive, non‑transferable, revocable</strong> right to access and use DhatuPay for your internal business purposes.</li>
                    ...
                    <section className='--bg-white terms-section-10 section-sm'>
                        <div className="container-sm">
                            ...
                            <ul>
                                ...
                                <li className='text-20 text-rg'><b>No legal advice.</b> DhatuPay provides tooling/automation; you remain responsible for your compliance decisions.</li>
                            </ul>
                        </div>
                    </section>
